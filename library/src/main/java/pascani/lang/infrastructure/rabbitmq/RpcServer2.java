...
/**
 * This class is a modified version of {@link RpcServer}, removing the ACK
 * confirmation. According with the RabbitMQ documentation, RPC servers using
 * the "amq.rabbitmq.reply-to" queue should not consume messages in ACK mode;
 * which this class, originally, does. Modifications can be found by searching
 * this file with the keyword "modified".
 * 
 * <p>
...
public class RpcServer2 {
	 ...
	 */
	public RpcServer2(Channel channel) throws IOException {
		this(channel, null);
	}
	 ...
	 */
	public RpcServer2(Channel channel, String queueName) throws IOException {
		_channel = channel;
	...
	protected QueueingConsumer setupConsumer() throws IOException {
		...
		_channel.basicConsume(_queueName, /* modified */true, consumer);
		return consumer;
	}
